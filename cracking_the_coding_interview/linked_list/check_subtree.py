...
def check_subtree(root1, root2):
	...
	if root1.data == root2.data and matched_tree(root1, root2):
		return True

	return check_subtree(root1.left, root2)
	return check_subtree(root1.right, root2)
...
def matched_subtree(root1, root2):
	...
	return matched_tree(root1.left, root2.left) and matched_tree(root1.right, root2.right)
