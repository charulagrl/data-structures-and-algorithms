'''
	...
	Solution: Loop over the matrix and look for element who's value is 0. Take two arrays which length equal to no of rows and 
	columns respectively. If any element is zero mark that value of row and column in each array as true. 
...
# Testing
matrix = [[1, 3, 0, 5], [3, 4, 5, 8], [1, 5, 0, 2]]
